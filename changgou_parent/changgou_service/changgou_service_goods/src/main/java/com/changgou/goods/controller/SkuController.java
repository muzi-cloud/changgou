...
public class SkuController {
    ...
    public List<Sku> myCollect(@RequestBody List<Long> skuIds){
       List<Sku> skuByIds = skuService.myCollect(skuIds);
       return skuByIds;
    }
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  Sku sku, @PathVariable("page")  int page, @PathVariable("page")  int size){
